...
\centering
  ...
  \draw(-4, -2.5)node[right]{$\eta'$};
  \draw[-Stealth](0,0)--node[right]{$\vb{n}$}(0,3);
  \draw[-Stealth]({3*cos(135)}, {3*sin(135)})--node[left]{$\vb{R}$}(0,0);

  \draw[-Stealth](0,0)--node[right]{$\vb{R'}$}({3*cos(-60)}, {3*sin(-60)});
  \draw[-Stealth](0,0)--node[left]{$\vb{R'}_\parallel$}(0, {3*sin(-60)});
  \draw[-Stealth](0,0)--node[above]{$\vb{R'}_\perp$}({3*cos(-60)}, 0);
  \draw[dashed]({3*cos(-60)}, 0)--({3*cos(-60)}, {3*sin(-60)});
  \draw[dashed](0, {3*sin(-60)})--({3*cos(-60)}, {3*sin(-60)});
  % \draw pic[draw=black, angle eccentricity=1.3, angle radius=1cm]{angle=}
  % \coordinate(A)at(0, 3);
  % \coordinate(B)at(0, 0);
  % \coordinate(C)at(0, -3);
  % \draw[thick](0, 7)--(0, -7);
